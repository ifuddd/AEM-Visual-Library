...
async function main() {
  ...
  const components = [
    ...
    // Advanced Enterprise Components
    {
      ...
      aemDialogSchema: {
        pretitle: { type: 'textfield', description: 'Optional pre-title/eyebrow text', maxlength: 50 },
        title: { type: 'textfield', required: true, description: 'Main headline', maxlength: 120 },
        titleType: { type: 'select', options: ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'], default: 'h2' },
        description: { type: 'richtext', maxlength: 500 },
        image: { type: 'pathbrowser', rootPath: '/content/dam' },
        imageAlt: { type: 'textfield' },
        imagePosition: { type: 'select', options: ['left', 'right', 'top', 'background'], default: 'left' },
        actions: { type: 'multifield', fields: { text: { type: 'textfield', required: true }, link: { type: 'pathfield', required: true }, style: { type: 'select', options: ['primary', 'secondary', 'link'] } } },
        variant: { type: 'select', options: ['default', 'hero', 'promo', 'card'], default: 'default' },
        titleLinkTarget: { type: 'pathfield' },
        showTitleLink: { type: 'checkbox', default: true },
      },
      aemAllowedChildren: [],
      aemTemplateConstraints: {
      ...
      aemLimitations: [
        ...
        'Rich text limited to basic formatting',
    ...
    },
    {
      ...
      aemDialogSchema: {
        layout: { type: 'select', options: ['default', 'full-width', 'contained', 'fluid'], default: 'default' },
        gridColumns: { type: 'select', options: ['1', '2', '3', '4', '6', '12'], default: '12' },
        columnGap: { type: 'select', options: ['none', 'small', 'medium', 'large'], default: 'medium' },
        backgroundColor: { type: 'colorfield' },
        backgroundImage: { type: 'pathbrowser', rootPath: '/content/dam' },
        backgroundVideo: { type: 'pathbrowser', rootPath: '/content/dam/videos' },
        backgroundSize: { type: 'select', options: ['cover', 'contain', 'auto'], default: 'cover' },
        backgroundPosition: { type: 'select', options: ['center', 'top', 'bottom', 'left', 'right'], default: 'center' },
        backgroundAttachment: { type: 'select', options: ['scroll', 'fixed', 'local'], default: 'scroll' },
        overlayEnable: { type: 'checkbox' },
        overlayColor: { type: 'colorfield', default: 'rgba(0,0,0,0.5)' },
        overlayOpacity: { type: 'slider', min: 0, max: 100, default: 50 },
        paddingTop: { type: 'select', options: ['none', 'small', 'medium', 'large', 'xlarge'], default: 'medium' },
        paddingBottom: { type: 'select', options: ['none', 'small', 'medium', 'large', 'xlarge'], default: 'medium' },
        marginTop: { type: 'select', options: ['none', 'small', 'medium', 'large', 'xlarge'], default: 'none' },
        marginBottom: { type: 'select', options: ['none', 'small', 'medium', 'large', 'xlarge'], default: 'none' },
        anchorId: { type: 'textfield' },
        cssClasses: { type: 'textfield' },
        componentSpacing: { type: 'select', options: ['compact', 'normal', 'relaxed'], default: 'normal' },
      },
      aemAllowedChildren: ['text', 'image', 'teaser', 'title', 'button', 'separator', 'embed', 'contentfragment', 'experiencefragment', 'container', 'carousel', 'tabs', 'accordion'],
      aemTemplateConstraints: {
        allowedParents: ['root', 'responsivegrid', 'container'],
      },
      aemLimitations: [
        'Background video autoplay muted only',
        'Parallax effect has performance implications on mobile',
    ...
    },
    {
      ...
      aemDialogSchema: {
        listFrom: { type: 'select', options: ['children', 'fixed', 'search', 'tags', 'querybuilder'], required: true },
        parentPage: { type: 'pathfield', showWhen: { listFrom: 'children' } },
        childDepth: { type: 'number', min: 1, max: 5, default: 1, showWhen: { listFrom: 'children' } },
        pages: { type: 'multipathfield', showWhen: { listFrom: 'fixed' } },
        tags: { type: 'tagfield', multiple: true, showWhen: { listFrom: 'tags' } },
        tagsMatch: { type: 'select', options: ['any', 'all'], default: 'any', showWhen: { listFrom: 'tags' } },
        searchQuery: { type: 'textfield', showWhen: { listFrom: 'search' } },
        searchIn: { type: 'pathfield', showWhen: { listFrom: 'search' } },
        queryBuilderQuery: { type: 'textarea', showWhen: { listFrom: 'querybuilder' } },
        orderBy: { type: 'select', options: ['title', 'modified', 'published', 'custom'], default: 'modified' },
        sortOrder: { type: 'select', options: ['asc', 'desc'], default: 'desc' },
        maxItems: { type: 'number', min: 1, max: 100, default: 10 },
        showDescription: { type: 'checkbox', default: true },
        showModificationDate: { type: 'checkbox', default: false },
        linkItems: { type: 'checkbox', default: true },
        displayAs: { type: 'select', options: ['default', 'grid', 'cards', 'compact'], default: 'default' },
        enablePagination: { type: 'checkbox', default: false },
        itemsPerPage: { type: 'number', default: 10, showWhen: { enablePagination: true } },
        paginationStyle: { type: 'select', options: ['numbered', 'load-more', 'infinite-scroll'], default: 'numbered', showWhen: { enablePagination: true } },
        dateFormat: { type: 'textfield', default: 'MMMM dd, yyyy' },
        emptyMessage: { type: 'textfield', default: 'No items to display' },
        enableFiltering: { type: 'checkbox' },
      },
      aemAllowedChildren: [],
      aemTemplateConstraints: {
      ...
      aemLimitations: [
        ...
        'Search source limited to 100 results',
